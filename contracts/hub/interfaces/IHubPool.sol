...
interface IHubPool is IERC20 {
    ...
    function preparePoolForWithdrawTsToken() external;
    ...
    function mintTsTokenForFeeRecipient(uint256 amount) external;
    function mintTsToken(address recipient, uint256 amount) external;
    function burnTsToken(address sender, uint256 amount) external;
}
