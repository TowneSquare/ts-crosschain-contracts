...
contract LoanManager is ReentrancyGuard, ILoanManager, LoanManagerState {
    ...
    function depositTsToken(
        ...
        LoanManagerLogic.executeDepositTsToken(
            _userLoans,
            _loanTypes,
            _pools,
            _userPoolRewards,
            _oracleManager,
            DataTypes.ExecuteDepositTsTokenParams({ loanId: loanId, poolId: poolId, sender: sender, fAmount: fAmount })
        );
    }
    ...
    function withdrawTsToken(
        ...
        LoanManagerLogic.executeWithdrawTsToken(
            _userLoans,
            _loanTypes,
            _pools,
            _userPoolRewards,
            _oracleManager,
            DataTypes.ExecuteWithdrawTsTokenParams({
                loanId: loanId,
                poolId: poolId,
                recipient: recipient,
                fAmount: fAmount
