...
contract WormholeDataAdapter is IBridgeAdapter, IWormholeReceiver, AccessControlDefaultAdminRules {
    ...
    mapping(uint16 townSqChainId => WormholeAdapterParams) internal townSqChainIdToWormholeAdapter;
    ...
    function receiveWormholeMessages(
        ...
        (uint16 wormholeChainId, bytes32 adapterAddress) = getChainAdapter(townSqChainId);
    ...
    function addChain(
        ...
        // add chain
        townSqChainIdToWormholeAdapter[townSqChainId] = WormholeAdapterParams({
            isAvailable: true,
    ...
    function getChainAdapter(uint16 chainId) public view returns (uint16 wormholeChainId, bytes32 adapterAddress) {
        WormholeAdapterParams memory chainAdapter = townSqChainIdToWormholeAdapter[chainId];
